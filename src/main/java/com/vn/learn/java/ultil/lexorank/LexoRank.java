...
import com.vn.learn.java.ultil.lexorank.system.LexoNumeralSystem36;
...
public class LexoRank implements Comparable<LexoRank> {
  ...
  private static LexoDecimal between(LexoDecimal oLeft, LexoDecimal oRight) {
    ...
    LexoDecimal nRight;
    for (int scale = left.getScale(); scale > 0; --scale) {
      int nScale1 = scale - 1;
  ...
  private static void checkSameSystem(LexoDecimal oLeft, LexoDecimal oRight) {
